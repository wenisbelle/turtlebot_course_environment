...
path = os.path.expanduser('~/.ros/tracing/yello_tshirt_detector')
...
ranges_detect_yellow_tshirt_callback = get_service_callback_ranges('detect_yellow_tshirt_callback')
...
search_string = 'detect_yellow_tshirt_callback'
num_pos_detect_yellow_tshirt_callback = None
for index, item in enumerate(segment_types):
    if search_string in item:
        num_pos_detect_yellow_tshirt_callback = index
        break
else:
    print(f"'{search_string}' not found in the list")
...
add_durations_to_figure(fig, 'detect_yellow_tshirt_callback', ranges_detect_yellow_tshirt_callback, 'green', line_width, num_pos_detect_yellow_tshirt_callback)
